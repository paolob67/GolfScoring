...
<a id="logo" class="navbar-brand" href="/golfscoring.html">Golf Scoring</a>
...
<div class="collapse navbar-collapse" id="navigationBar">
  <ul class="navbar-nav mr-auto">
    <li class="nav-item active">
      <a class="nav-link" href="/golfscoring.html">Home <span class="sr-only">(current)</span></a>
    </li>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="signUpTitle">Golf Scoring Sign Up</h5>
          </div>
  ...
  <div class="modal" id="logInModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="logInTitle">Golf Scoring Log In</h5>
        </div>
        <div class="modal-body">
          <form id="logInForm">
            <div class="form-group">
...
<div class="card-body">
  ...
  <p class="card-text description">
    ...
    <div><b>Club</b> <input id="profile-club" value="#CLUB-NAME#"></div>
    <div><b>Card</b> <input id="profile-card" value="#CARD#"></div>
    <div><b>Handicap</b> <input id="profile-handicap" value="#HANDICAP#"></div>
    <div id="profile-gender"><b>Gender</b>
      <input type="radio" id="gender-male" name="genderRadios">
      <label for="gender-male">Male</label>
      <input type="radio" id="gender-female" name="genderRadios">
